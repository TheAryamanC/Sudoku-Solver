...
# Find location of empty cells to fill in
def empty_cells(sudoku):
    return np.argwhere(sudoku == 0)

# Check to see if number is valid (compare with other values in row, column and 3x3 box)
...
# To do: format the puzzle to look like a sudoku
